...
// @EnableGlobalMethodSecurity(securedEnabled = true) // false zet de @Secured annotaties uit
// @EnableAspectJAutoProxy
public class AutodealerApplication extends WebSecurityConfigurerAdapter {
